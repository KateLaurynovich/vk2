package application.forms.sideBar;
...
public class SideBar {
    ...
    private static String menuItemLocator = "//li[contains(@id, 'l_%s')]//a";

    public Label getElementMenu(MenuCategory name) {
        return new Label(By.xpath(String.format(menuItemLocator, name.getTitle())), name.getTitle());
    }
