...
import application.request.like.enums.Like;
import application.request.wall.parameters.AttachmentParams;
import application.forms.header.TopCategory;
import application.model.CommentModel;
import application.forms.sideBar.MenuCategory;
...
import application.request.like.Likes;
import application.request.wall.Wall;
...
public class TestAPIVK {
    ...
    @DataProvider
    public Object[][] getCase1() {
        return new Object[][]{{"pathImg", "pathImg2", 100}};
    }

    @Test(dataProvider = "getCase1")
    public void testCase1(String path1, String path2, float interest) {
        ...
        PhotoParam photo = SaveFile.savePhoto(editedPostModel, PropertiesManager.getProperties(path1), AttachmentParams.PHOTO, user);
        editedPostModel.setAttachments(AttachmentsList.create().add(AttachmentParam.PHOTO, photo.getId()));
        ...
        FileManager.saveImg(myProfilePage.getPost().getLinkPhoto(editedPostModel, photo), PropertiesManager.getProperties(path2));
    ...
    public void testCase4() {
        ...
        AttachmentsList attachments = AttachmentsList.create().add(AttachmentParam.DOC, SaveFile.saveFile(editedPostModel,
                PropertiesManager.getProperties("pathFile") + PropertiesManager.getProperties("fileName"), AttachmentParams.FILE, user1));
    ...
    public void testCase5(String path1, String path2, float interest) {
        ...
        PhotoParam photo = SaveFile.savePhoto(postModel, PropertiesManager.getProperties(path1), AttachmentParams.PHOTO, user2);
        postModel.setAttachments(AttachmentsList.create().add(AttachmentParam.PHOTO, photo.getId()));
